...
REQUIRED_JSON = [
    ...
    "guard-approvals.json", "guard-wallet.json", "guard-capabilities.json", "guard-horizon.json", "guard-future-signals.json", "guard-threat-report.json",
]
...
REQUIRED_SCRIPTS = [
    ...
    "test_opportunity_intelligence.py", "test_guard_evolution.py", "verify_global_discovery.py", "guard_evolution_engine.py", "guard_horizon_engine.py", "future_opportunity_scout.py", "guard_threat_engine.py", "test_guard_threat_engine.py",
]
...
def main():
    ...
    threat = load("guard-threat-report.json")
    assert threat.get("status") == "PASS"
    assert threat.get("violations") == []
