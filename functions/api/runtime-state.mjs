const state=globalThis.__ANILX_RUNTIME_STATE||(globalThis.__ANILX_RUNTIME_STATE={accounts:new Map(),sessions:new Map(),orders:new Map(),freeRequests:new Map(),revenueLeads:new Map(),queue:new Map()});
